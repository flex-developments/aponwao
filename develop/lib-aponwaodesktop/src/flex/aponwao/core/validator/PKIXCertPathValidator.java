/*
 * @(#)PKIXCertPathValidator.java	1.17 08/09/08
 *
...
public class PKIXCertPathValidator extends CertPathValidatorSpi {
	...
	if (pkixParam.isRevocationEnabled()) {
		...
		new PrivilegedAction() {
            ...
            boolean onlyEECert = 
                "true".equalsIgnoreCase(onlyEECertProp) ? true : false;
	    ...
	    // Always use CRLs
	    CrlRevocationChecker revocationChecker = new CrlRevocationChecker
                (trustedPubKey, pkixParam, certList, onlyEECert);
