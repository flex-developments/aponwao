...
public class PasswordStringFieldEditor extends FieldEditor {
	...
	private static Logger logger = Logger.getLogger(PasswordStringFieldEditor.class.getName());
	/**
	 ...
	 *            the parent of the field editor's control
	 */
	public PasswordStringFieldEditor(String name, String labelText, int width, Composite parent) {
	...
	/**
	 * Informs this field editor's listener, if it has one, about a change to the value (<code>VALUE</code> property) provided that the old
