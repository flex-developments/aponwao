...
public class SoftwareCertPreferences extends FieldEditorPreferencePage {
	...
	public SoftwareCertPreferences() {
		...
		for (String name: PreferencesHelper.getSoftwarePreferences().keySet()) {
			tempMap.put(name, PreferencesHelper.getSoftwarePreferences().get(name) );
		}
		
		tempDefault = PreferencesHelper.getPreferences().getString(PreferencesHelper.SOFTWARE_DISPOSITIVE);
	}
	...
	private void createDefaultArea() {
		...
		labelDefaultAreaTitle.setText(LanguageResource.getLanguage().getString("preferences.cert.software.default_title"));
		...
		labelDefaultAreaDesc.setText(LanguageResource.getLanguage().getString("preferences.cert.software.default_cert"));
		...
		reloadComboDefault();
		comboDefault.setText(PreferencesHelper.getPreferences().getString("default.software.cert"));
	...
	private void savePreferences() {
		...
		if (comboDefault != null) {
			...
			PreferencesHelper.saveSoftwarePreferences(tempMap);
			PreferencesHelper.getPreferences().setValue(PreferencesHelper.SOFTWARE_DISPOSITIVE, comboDefault.getText());
		}
	}
