 ...
 *
 */
package flex.aponwao.gui.sections.preferences.components;
 ...
 * </p>
 */
public class GenericStringFieldEditor extends FieldEditor {
	 ...
	 */
	protected GenericStringFieldEditor() {
	}
	 ...
	 * @since 2.0
	 */
	public GenericStringFieldEditor(String name, String labelText, int width, int strategy, Composite parent,
			int widthHint) {
		init(name, labelText);
		widthInChars = width;
	 ...
	 * @param widthHint
	 */
	public GenericStringFieldEditor(String name, String labelText, int width, Composite parent, int widthHint) {
		this(name, labelText, width, VALIDATE_ON_KEY_STROKE, parent, widthHint);
	}
	 ...
	 * @param widthHint
	 */
	public GenericStringFieldEditor(String name, String labelText, Composite parent, int widthHint) {
		this(name, labelText, UNLIMITED, parent, widthHint);
	}
	...
	public Text getTextControl(Composite parent) {
		if (textField == null) {
			...
			if (array.length > 0 && this.widthHint > 0)
	 ...
	 * 
	 * @param b
	 *            <code>true</code> if the empty string is allowed, and <code>false</code> if it is considered
	 *            invalid
	 */
	 ...
	 * <p>
	 * Calling this method has no effect after <code>createPartControl</code> is called. Thus this method is really
	 * only useful for subclasses to call in their constructor. However, it has public visibility for backward
	 * compatibility.
	 * </p>
	 * 
	 * @param value
