...
public class SoftwareCertUpdateDialog extends Dialog {
	...
	private static Logger		logger				= Logger.getLogger(SoftwareCertUpdateDialog.class.getName());
	...
	public void open() {
		...
		sShell.setText(LanguageResource.getLanguage().getString("preferences.cert.software.dialog.title"));
	...
	private void createCompositeFields() {
		...
		labelName.setText(LanguageResource.getLanguage().getString("preferences.cert.software.dialog.name"));
		...
		labelPath.setText(LanguageResource.getLanguage().getString("preferences.cert.software.dialog.path"));
	...
	class ButtonBrowseListener implements SelectionListener {
		...
		public void widgetSelected(SelectionEvent event) {
			...
			String filePath = FileDialogs.openFileDialog(sShell, FileDialogs.P12_TYPE);
