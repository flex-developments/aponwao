 ...
 * @author	Yassir Elley
 */
public class AponwaoCertPathValidator {
     ...
     */
    protected AponwaoCertPathValidator(CertPathValidatorSpi validatorSpi, 
     ...
     */
    public static AponwaoCertPathValidator getInstance(String algorithm)
	    throws NoSuchAlgorithmException {
	Instance instance = GetInstance.getInstance("CertPathValidator", 
	    CertPathValidatorSpi.class, algorithm);
	return new AponwaoCertPathValidator((CertPathValidatorSpi)instance.impl,
     ...
     * @see java.security.Provider
     */
    public static AponwaoCertPathValidator getInstance(String algorithm, Provider provider) throws NoSuchAlgorithmException {
    	
//		Instance instance = GetInstance.getInstance("CertPathValidator", CertPathValidatorSpi.class, algorithm, provider);
//		return new AponwaoCertPathValidator((CertPathValidatorSpi) instance.impl, instance.provider, algorithm);
    	
    	System.out.println("AponwaoCertPathValidator...");
    	
    	
		return new AponwaoCertPathValidator((CertPathValidatorSpi) new PKIXCertPathValidator(), provider, algorithm);
