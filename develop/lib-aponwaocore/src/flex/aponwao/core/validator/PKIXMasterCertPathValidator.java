/*
 * @(#)PKIXMasterCertPathValidator.java	1.13 05/11/17
 *
...
//		    }
		    ...
		    if (ocspCause != null && currChecker instanceof CrlRevocationChecker) {
		    	...
		    	// le sumo esta condicion para que si falla por estar revocado si que lo muestre
		    	if (!cpve.getMessage().contains("Certificate has been revoked")) {
